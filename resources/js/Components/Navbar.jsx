    ...
    return (
        <>
            <motion.div
                ...
                custom={height}
                className={`parent_button_mobile_menu ${isOpen ? "open" : "closed"}`}
                ref={containerRef}
            >
                        ...
                        <AnimatePresence>
                            ...
                            <>
                                <motion.aside
                                    ...
                                    className={`${isOpen ? `overflow-y-auto` : `overflow-y-hidden`} overflow-x-hidden`}
                                >
                                    <motion.div
                                        className={`container ${isOpen ? "block" : "hidden"}`}
                                        initial="closed"
                                        animate="open"
                                        exit="closed"
                                    >
                                        <Link href="/" className='flex justify-center pt-2 pb-6'><img src={logo} className="logo" alt="logo" /></Link>
                                        {navbar.map((elem, i) => {
